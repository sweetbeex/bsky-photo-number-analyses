...
[![Main comparison chart](charts/main_comparison.png)](charts/main_comparison.png)
...
- **`charts/`** — all PNG charts embedded in this README (generated by the script).
...
![Mean likes by image count](charts/per_count_likes.png)
...
![Median likes by image count](charts/per_count_median_likes.png)
...
![1 vs 3](charts/one_vs_three.png)

**Verdict: no difference.** *p* = 0.17, Cliff's *d* = +0.03. The means and distributions are effectively indistinguishable. Note the wider CI on the 3-img bar — that group is smaller (*n* = 550), so we have less precision.

### 1 photo vs 4 photos

![1 vs 4](charts/one_vs_four.png)
...
![Pairwise heatmap](charts/pairwise_heatmap.png)
...
![Hour of day](charts/hour_of_day.png)
...
![Author tier by followers](charts/author_tier_followers.png)
...
![Author tier by median engagement](charts/author_tier_median_engagement.png)
...
![Caption stratified](charts/caption_stratified.png)
...
![Aspect ratio](charts/aspect_ratio.png)
...
![Inequality](charts/inequality.png)
...
![Zero inflation](charts/zero_inflation.png)
...
![Composition](charts/composition.png)
...
├── charts/                         # all 17 PNG charts in this README
├── data/
